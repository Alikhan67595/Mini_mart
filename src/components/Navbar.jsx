...
const firstLetter = (!user?.photoURL) ? user?.displayName[0].toLocaleUpperCase() : " "
    ...
    <nav className='box-border w-screen h-[60px] bg-[#141414] border-b-[1px] border-[#262626]   hidden md:flex flex-col items-center justify-center pb-[20px] pt-[20px] fixed top-0 z-20 mb-[60px] '>
        ...
        <ul className='flex items-center gap-4'>
            <NavLink to={"/"} className={({ isActive }) => 
                ` rounded-[8px] ease-in duration-150 hover:font-semibold hover:bg-white hover:text-[#703bf7]   ${
  ...
  :
    <nav className='box-border w-screen h-[60px] bg-[#141414] border-b-[1px] border-[#262626]   hidden md:flex flex-col items-center justify-center pb-[20px] pt-[20px] fixed top-0 z-20 mb-[60px] '>
        ...
        <ul className='flex items-center gap-4'>
            ...
            <NavLink to={"/contact"} className={({ isActive }) => 
                `rounded-[8px] ease-in-out duration-150 hover:font-semibold hover:bg-white hover:text-[#703bf7]   ${
                  isActive ? "bg-[#703bf7] text-white font-semibold  " : "text-white"
                }`
              }><li className=' px-[15px] py-[8px] rounded-[8px]'>Contact</li></NavLink>

            <NavLink to={"/"} className={(!user.photoURL)? "bg-[#703bf7] text-white text-[25px] w-[40px] h-[40px] rounded-[50%] flex justify-center items-center hover:shadow-[0_1px_10px_rgba(255,255,255,0.4)]" :"p-[4px] rounded-[50%] ease duration-200 bg-[#fff0] hover:shadow-[0_1px_10px_rgba(255,255,255,0.4)]"} >
            <img className={(!user.photoURL) ? "hidden":'w-[40px] h-[40px] rounded-[50%]'}  src={user?.photoURL} alt="" />
